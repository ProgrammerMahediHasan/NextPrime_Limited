 <div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between"> 
         ...
         <div class="clearfix">
            ...
            <span>Mon, Aug 01, 2025 - Sep 01, 2026 </span>
          </div>
            ...
            <div class="card">
              <div class="card-header d-flex align-items-center justify-content-between border-0 pb-0">
                ...
                <select class="selectpicker" data-style="btn-sm btn-outline-light btn-shadow waves-effect">
                  <option value="pending">2025</option>
                  <option>2024</option>
                  <option>2023</option>
                  <option>2022</option>
                  <option>2020</option>
              ...
              <div class="card-footer">
                <div class="row gy-3 align-items-center">
                  <div class="col-sm-6">
                    <p class="mb-0">2025 Download Report Company Trends and Insights</p>
                  </div>
                ...
                <div class="card-body gradient-layer" style="height: 325px;" data-simplebar>
                  ...
                  <div class="p-3 bg-light bg-opacity-50 mb-2 rounded">
                    <div class="d-flex align-items-center justify-content-between">
                      ...
                      <div class="clearfix d-flex align-items-center">
                        <div class="btn-group">
                          <button class="btn btn-action-dark btn-sm btn-icon waves-effect dropdown-toggle" aria-label="Meeting options menu" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <i class="fi fi-rr-menu-dots"></i>
                          </button>
                          <ul class="dropdown-menu dropdown-menu-end">
                            <li>
